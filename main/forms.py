...
class CreateRecipeForm(forms.Form):
    ...
    description = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control form-control descriptionTextArea'}), label='Opis', max_length=10000, required=True)
    imageUrl = forms.URLField(label='Adres url obrazka', required=True, max_length=255, widget=forms.URLInput(attrs={'class': 'form-control form-control'}))
